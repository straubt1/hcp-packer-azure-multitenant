...
source "azure-arm" "ubuntu-t01" {
  tenant_id       = var.tenant01.tenant_id
  subscription_id = var.tenant01.subscription_id
  client_id       = var.tenant01.client_id
  client_secret   = var.tenant01.client_secret
  ...
  managed_image_resource_group_name = var.azure_configuration.image_resource_group_name
  ...
  #   subscription        = var.azure_credentials.subscription_id
  #   resource_group      = var.azure_configuration.image_resource_group_name
  #   gallery_name        = var.azure_configuration.image_gallery_name
  #   replication_regions = var.azure_configuration.image_regions
...
source "azure-arm" "ubuntu-t02" {
  tenant_id       = var.tenant02.tenant_id
  subscription_id = var.tenant02.subscription_id
  client_id       = var.tenant02.client_id
  client_secret   = var.tenant02.client_secret
